...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="form-container hidden" id="formContainer">
            ...
            <h2 class="form-title">
                <i class="fa-solid fa-file-contract" style="margin-right: 12px; color: #2563eb;"></i>
                Knitting Program
            </h2>
            ...
            <form id="knittingForm">
                ...
                <div id="detailsContainer">
                    <div class="form-section">
                        <div class="section-title">
                            <i class="fa-solid fa-thread" style="margin-right: 8px;"></i>
                            Yarn & Fabric Details
                        </div>
                    ...
                    <div class="form-section">
                        <div class="section-title">
                            <i class="fa-solid fa-shirt" style="margin-right: 8px;"></i>
                    ...
                    <div class="mcno-qty-section">
                        ...
                        <table class="mcno-qty-table">
                            <thead>
                                <tr>
                                    <th style="width: 5%;">#</th>
                                    <th style="width: 30%;">MCNO</th>
                                    <th style="width: 30%;">QTY</th>
                                    <th style="width: 30%;">Remaining QTY</th>
                ...
                <div class="action-buttons" style="margin-top: 32px;">
                    <button type="button" class="btn-submit" id="submitBtn">
                        <i class="fa-solid fa-paper-plane"></i> Save Program
                    </button>
                </div>
            </form>
        </div>
    ...
    <script>
        ...
        function loadFormData(booking) {
            ...
            .done(function(resp) {
                ...
                if (resp && resp.success && resp.data) {
                    ...
                    showAlert(resp.error || 'No data found for this booking.', 'error');
                }
            })
        ...
        function checkAddRowButton() {
            ...
            rows.each(function() {
                ...
                // If QTY is disabled, row is not valid
                if (qtyDisabled) {
                    allRowsValid = false;
                    allFilled = false;
                    return false;
        ...
        function updateRemainingQty() {
            ...
            rows.each(function(index) {
                ...
                previousTotal += rowQty;
                
                // Remaining QTY = Target - Total QTY up to this row
                var rowRemaining = targetQty - previousTotal;
                $(this).find('.remaining-qty').val(rowRemaining >= 0 ? rowRemaining.toFixed(2) : '0.00');
            });

            // Update summary row
            var totalQtySum = previousTotal;
        ...
        $(function() {
            ...
            $('#submitBtn').on('click', function(e) {
                ...
                if (!mcnoResult.isValid) {
                    showAlert('Please fill all MCNO and QTY fields with valid data.', 'error');
                    return;
                }
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            showAlert(response.error || 'Failed to save program.', 'error');
                        }
                    },
                    error: function() {
